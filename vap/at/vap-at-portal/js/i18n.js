...
const i18n = {
    ...
    en: {
        ...
        assessment: {
            ...
            generateReport: "Score Report (PDF)",
            downloadEvidence: "Evidence Pack v1.0 (JSON)",
        ...
        designations: {
            euAiAct: "EU AI Act Art.12/19 aligned",
            mifid: "MiFID II RTS 25 aligned",
            baseline: "Baseline Auditability"
        },
        registry: {
    ...
    ja: {
        ...
        assessment: {
            ...
            disclaimer: "これはVAP-AT Level 1（自己評価ツール）です。結果は暫定的であり、第三者による検証はありません。閾値判定ラベルは解釈レイヤであり、法的コンプライアンスの保証ではありません。この結果は評価スコアであり、規制当局による承認・適合判断を示すものではありません。"
        },
        grades: {
            strong: "Strong（堅牢）",
    ...
    zh: {
        ...
        assessment: {
            ...
            disclaimer: "这是VAP-AT Level 1（自我评估工具）。结果是初步的，未经独立验证。阈值标识是解释性标签，不是法律合规保证。此结果为评估分数，不构成监管机构的批准或合规认定。"
        },
        grades: {
            strong: "强健",
            moderate: "中等",
    ...
    es: {
        ...
        assessment: {
            ...
            generateReport: "Informe de Puntuación (PDF)",
            downloadEvidence: "Evidence Pack v1.0 (JSON)",
            ...
            disclaimer: "Este es VAP-AT Level 1 (Herramienta de Autoevaluación). Los resultados son preliminares y no están verificados independientemente. Las Designaciones de Umbral son etiquetas interpretativas, no garantías de cumplimiento legal. Este resultado es una puntuación de evaluación y no constituye aprobación regulatoria ni determinación de conformidad."
        },
        grades: {
            strong: "Fuerte",
            moderate: "Moderado",
